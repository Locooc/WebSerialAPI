...
var serial_handler_js_1 = require("./serial-handler.js");
/**
 * UI specific code
    ...
    function WebSerialDemoApp() {
        ...
        this.connectButtonElem.addEventListener('pointerdown', function () { return __awaiter(_this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, serial_handler_js_1.serialHandler.init()];
                    case 1:
                        _a.sent();
        ...
        this.messageButtons.forEach(function (button) {
            button.addEventListener('pointerdown', function () {
                serial_handler_js_1.serialHandler.write(String(button.dataset.value));
            ...
            return __generator(this, function (_d) {
                switch (_d.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, serial_handler_js_1.serialHandler.read()];
                    case 1:
